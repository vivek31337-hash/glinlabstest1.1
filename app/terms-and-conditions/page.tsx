      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing or using GLINLABS services ("Services"), you agree to be bound by these Terms 
          ...
          <section>
            ...
            <p>
              GLINLABS provides AI-powered security intelligence services, including but not limited to 
              security consulting, threat analysis, vulnerability assessment, and related cybersecurity 
              services. We reserve the right to modify, suspend, or discontinue any part of the Services 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Not share your account with others or use another person's account</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Engage in any activity that could harm, disable, or impair the Services</li>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              graphics, logos, software, and designs, are owned by GLINLABS or our licensors and are 
              protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p>
              You are granted a limited, non-exclusive, non-transferable license to access and use the 
              Services for personal or internal business purposes. You may not reproduce, distribute, 
              modify, or create derivative works without our prior written consent.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. User Content</h2>
            <p className="mb-3">
              You retain ownership of any content you submit or upload to the Services ("User Content"). 
              By submitting User Content, you grant us a worldwide, non-exclusive, royalty-free license to 
              use, reproduce, modify, and display your User Content solely for the purpose of providing the 
              Services.
            </p>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Payment and Billing</h2>
            <p className="mb-3">
              Certain Services may require payment. By providing payment information, you:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Authorize us to charge the applicable fees to your payment method</li>
              <li>Agree to pay all fees and charges incurred</li>
              <li>Understand that fees are non-refundable except as required by law</li>
              <li>Agree that we may change our fees with prior notice</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              We do not guarantee that the Services will meet your requirements or that the results obtained 
          ...
          <section>
            ...
            <p className="mb-3">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, GLINLABS SHALL NOT BE LIABLE FOR ANY INDIRECT, 
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless GLINLABS, its officers, directors, employees, 
              and agents from any claims, liabilities, damages, losses, and expenses arising out of or related 
          ...
          <section>
            ...
            <p>
              ...
              in which GLINLABS operates, without regard to its conflict of law provisions. Any disputes 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">14. Severability</h2>
            <p>
