      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              Welcome to GLINLABS ("we," "our," or "us"). We are committed to protecting your personal 
          ...
          <section>
            ...
            <p className="mb-3">
              We do not sell or rent your personal information. We may share your information in the 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. GDPR Compliance (EU Users)</h2>
            <p>
              If you are located in the European Union, we process your personal data in accordance with 
              the General Data Protection Regulation (GDPR). You have specific rights under GDPR, including 
              the right to lodge a complaint with a supervisory authority.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">9. CCPA Compliance (California Users)</h2>
            <p>
              If you are a California resident, you have rights under the California Consumer Privacy Act 
              (CCPA), including the right to know what personal information we collect, the right to delete 
              your information, and the right to opt-out of the sale of your information (we do not sell 
          ...
          <section>
            ...
            <p>
              ...
              activity on our services. For more information, please see our Cookies Policy.
            </p>
          </section>
